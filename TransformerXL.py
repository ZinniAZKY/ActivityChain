...
def parse_arguments():
   ...
   parser.add_argument('--train_file', default='/home/ubuntu/PycharmProjects/pythonProject/MobilityGPT/data'
                                               '/Tokyo2008PTChain_Mode_6_24_Train.txt', type=str)
   parser.add_argument('--val_file', default='/home/ubuntu/PycharmProjects/pythonProject/MobilityGPT/data'
                                             '/Tokyo2008PTChain_Mode_6_24_Eval.txt', type=str)
   parser.add_argument('--enhance_file', default='/home/ubuntu/PycharmProjects/pythonProject/MobilityGPT/data'
                                                 '/TokyoShopEnhanceWeekday0509.txt', type=str)
   return parser.parse_args()


def load_datasets(tokenizer, train_file, val_file, enhance_file):
   train_dataset = TextDataset(train_file, tokenizer, n_rows=50000)
   eval_dataset = TextDataset(val_file, tokenizer, n_rows=5000)
...
def initialize_model_and_training_args(tokenizer, args):
   ...
   training_args = TrainingArguments(
       f"/home/ubuntu/PycharmProjects/pythonProject/MobilityGPT/output/{args.model_name}",
