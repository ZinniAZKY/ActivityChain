...
In Tripchain.py, we transform the original OD trajectories into activity chain of 15 minutes time series. Notice that '@' in the input data need to be replaced by '_' to use this tokenizer, and in Osaka, the actibity number of 46 and 47 in PT original data needed to be changed namually.
