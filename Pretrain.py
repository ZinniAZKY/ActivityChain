...
#
# train_file = "/home/ubuntu/Documents/TokyoPT/PTChain/IDcombinedhalfTrain.txt"
# val_file = "/home/ubuntu/Documents/TokyoPT/PTChain/IDcombinedhalfEval.txt"
#
# device = torch.device('cuda' if torch.cuda.is_available() else 'cpu')
#
# with open(train_file, "r", encoding="utf-8") as f:
...
#
#
# def create_dataset_with_embeddings(original_texts, encodings):
#     occupation_embeds = []
#     gender_embeds = []
#
#     # Extract attributes using original_texts
...
#         occupation_embeds.append(occupation_embed)
#         gender_embeds.append(gender_embed)
#
#     input_ids = torch.tensor(encodings.input_ids)
#     labels = [seq[-1] for seq in input_ids]
#
#     occupation_embeds = torch.stack(occupation_embeds).squeeze(1)
#     gender_embeds = torch.stack(gender_embeds).squeeze(1)
#
#     return TensorDataset(input_ids, torch.tensor(labels), occupation_embeds, gender_embeds)
#
#
# batch_size = 1024
# train_dataset = create_dataset_with_embeddings(train_texts, train_encodings)
# val_dataset = create_dataset_with_embeddings(val_texts, val_encodings)
# train_dataloader = DataLoader(train_dataset, batch_size=batch_size, shuffle=True)
